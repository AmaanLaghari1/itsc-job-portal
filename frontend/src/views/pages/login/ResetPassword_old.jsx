...
export default function ResetPassword() {
    ...
    useEffect(() => {
        async function verifyToken(token, cnic){
            try {
                const response = await verifyPasswordToken(token, cnic)
    ...
    return (
        ...
        <div className="bg-primary min-vh-100 d-flex align-items-center">
            ...
            <Formik
                initialValues={{cnic_no: cnic || '', password: '', password_confirmation: ''}}
