...
class ApplicationPDF extends FPDF
{
    ...
    public function Header()
    {
        ...
        $this->Image(public_path('images/usindh-logo2.PNG'), 10, 5, 20, 20, '', '');
...
//        $this->SetFont('Times', '', 10);
    ...
    public function sumTotalExperience($experienceData) {
        ...
        foreach ($experienceData as $item) {
            ...
            $endDate = is_null($item->END_DATE) ? date('d-m-Y') : date('d-m-Y', strtotime($item->END_DATE));
    ...
    public function RequiredData($data = []) {
        ...
        return [
            ...
            "POSITION_APPLIED_FOR" => $data['announcement']['POSITION_NAME'] . " at " . $data['announcement']['DEPT_NAME'],
